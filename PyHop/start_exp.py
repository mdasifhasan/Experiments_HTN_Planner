...
print('ASIF- If verbose=1, Pyhop prints the problem and solution, and returns the solution:')
pyhop.pyhop(state1,[('travel','me','home','park'), ('travel','you','home','park')],verbose=1)